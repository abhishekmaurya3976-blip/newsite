  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setErrors({ submit: response.error || 'Failed to create coupon' });
      }
    } catch (error: any) {
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Maximum times a single user can use this coupon</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2">Inactive coupons cannot be used by customers</p>
            </div>
