...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    support: [
      ...
      { name: 'Shipping Info', href: '/policy/shipping' },
      { name: 'Returns', href: '/policy/returns' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-gray-300 text-sm">
              ...
              Quality products for creative minds and professionals.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © {currentYear} Art Palzaa. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 flex space-x-6">
            <span className="text-gray-300 text-sm">Secure payments</span>
            <span className="text-gray-300 text-sm">Free shipping over ₹999</span>
          </div>
        </div>
      </div>
    </footer>
